...
Usage:
  ...
  # Create train data:
  python generate_tfrecord.py --mode=train --csv_input=data/train_labels.csv  --output_path=train.record

  # Create test data:
  python generate_tfrecord.py --mode=test --csv_input=data/test_labels.csv  --output_path=test.record
"""
